...
export default function TourDemo({ idx, t, heading }) {
  ...
  return (
    <div className="  active:bg-red-200 outline-2 outline-offset-1 outline-red-100  font-sanf tracking-wider rounded m-2 flex justify-center items-center flex-col h-50 p-4 hover:bg-blue-100 hover:transition duration-300 ease-in-out w-60 hover:shadow-2xl transition-shadow duration-500 hover:scale-105 transition ease-in-out duration-300">
